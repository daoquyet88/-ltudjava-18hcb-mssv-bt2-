...
/**
 * DkmhId generated by hbm2java
 */
public class DkmhId  implements java.io.Serializable {
    ...
    public DkmhId(String maLop, String maMon, String maSv) {
       this.maLop = maLop;
       this.maMon = maMon;
       this.maSv = maSv;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof DkmhId) ) return false;
		 DkmhId castOther = ( DkmhId ) other; 
